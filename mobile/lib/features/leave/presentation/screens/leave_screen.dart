      ...
      body: Column(
        children: [
          Container(
            ...
            child: TabBar(
              controller: _tab,
              tabs: const [Tab(text: 'Apply Leave'), Tab(text: 'My History')],
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 8,
              children:
                  ['CL', 'SL', 'Medical', 'Personal', 'Other'].map((type) {
            ...
            Row(
              children: [
                Expanded(
                  child: _DateCard(
                    label: 'From',
                    date: _from != null ? fmt.format(_from!) : 'Select date',
                ...
                Expanded(
                  child: _DateCard(
                    label: 'To',
                    date: _to != null ? fmt.format(_to!) : 'Select date',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text('Apply for leave from the first tab',
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          final fromDate = _fmtDate(l['fromDate']);
          final toDate = _fmtDate(l['toDate']);
          final days = l['days'] ?? 1;
          final type = l['leaveType'] ?? 'Leave';
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (status == 'rejected' &&
                    l['adminNote'] != null &&
                    (l['adminNote'] as String).isNotEmpty) ...[
                  const SizedBox(height: 8),
                  Container(
